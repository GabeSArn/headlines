...
def fox_10_news_scraper():
    fox_10_news = urlopen('www.fox10tv.com/')
...
def wbrc_scraper():
    wbrc_birmingham = urlopen('www.wbrc.com/')
...
def al_birmingham_scraper():
    al_birmingham = urlopen('www.al.com/birmingham/')
...
def nbc_dc_news_scraper():
    ### NBC Washington D.C.
    wdc_nbc4 = urlopen('www.nbcwashington.com/')
...
def wdc_fox_scraper():
    wdc_fox = urlopen('www.fox5dc.com/')
